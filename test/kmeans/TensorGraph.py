...
class TensorGraph:
    ...
    def create_input_placeholder(self):
        image_size = 28
        num_labels = 10
        tf_dataset = tf.placeholder(tf.float32, shape=(self.batch_size, image_size * image_size))
        tf_labels = tf.placeholder(tf.float32, shape=(self.batch_size, num_labels))
        tf_test_dataset = tf.placeholder(tf.float32, shape=(10000, image_size * image_size))
